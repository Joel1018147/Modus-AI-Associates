...
export const PAGE_META: Record<Lang, { home: PageMeta; details: PageMeta }> = {
  en: {
    ...
    details: {
      ...
      description:
        "Explore MODUS AI Associates' AI services, 12 MIIT-certified courses and 84 integrated AI systems — including the M-Easy enterprise Super Apps — bridging Malaysia and China's AI ecosystem.",
    },
  },
  bm: {
    home: {
    ...
    details: {
      ...
      description:
        "Terokai perkhidmatan AI, 12 kursus bertauliah MIIT dan 84 sistem AI bersepadu MODUS AI Associates — termasuk Super Apps perusahaan M-Easy — yang menghubungkan ekosistem AI Malaysia dan China.",
    },
  },
  cn: {
    home: {
    ...
    details: {
      ...
      description:
        "探索 MODUS AI Associates 的人工智能服务、12 项 MIIT 认证课程及 84 个集成人工智能系统（含 M-Easy 企业级超级应用），连接马中人工智能生态系统。",
    },
  },
  id: {
    home: {
    ...
    details: {
      ...
      description:
        "Jelajahi layanan AI, 12 kursus bersertifikat MIIT, dan 84 sistem AI terintegrasi MODUS AI Associates — termasuk Super Apps perusahaan M-Easy — yang menghubungkan ekosistem AI Malaysia dan China.",
    },
  },
  vn: {
    home: {
    ...
    details: {
      ...
      description:
        "Khám phá dịch vụ AI, 12 khóa học được MIIT chứng nhận và 84 hệ thống AI tích hợp của MODUS AI Associates — bao gồm các Super App doanh nghiệp M-Easy — kết nối hệ sinh thái AI Malaysia và Trung Quốc.",
    },
  },
  ar: {
    home: {
    ...
    details: {
      ...
      description:
        "استكشف خدمات الذكاء الاصطناعي و12 دورة معتمدة من MIIT و84 نظامًا متكاملًا للذكاء الاصطناعي من MODUS AI Associates — بما في ذلك تطبيقات M-Easy الفائقة للمؤسسات — التي تربط منظومتي ماليزيا والصين.",
    },
  },
  th: {
    home: {
    ...
    details: {
      ...
      description:
        "สำรวจบริการ AI หลักสูตรที่ได้รับการรับรองจาก MIIT 12 หลักสูตร และระบบ AI แบบครบวงจร 84 ระบบของ MODUS AI Associates รวมถึง M-Easy Super Apps สำหรับองค์กร ที่เชื่อมระบบนิเวศ AI มาเลเซียและจีน",
    },
  },
};
