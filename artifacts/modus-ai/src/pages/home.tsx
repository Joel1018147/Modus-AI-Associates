...
const content = {
  en: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Our Systems", desc: "82 integrated AI systems" },
  ...
  bm: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "82 sistem AI bersepadu" },
  ...
  cn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "我们的系统", desc: "82个集成 AI 系统" },
  ...
  id: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "82 sistem AI terintegrasi" },
  ...
  vn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Hệ Thống Của Chúng Tôi", desc: "82 hệ thống AI tích hợp" },
  ...
  ar: {
    ...
    navItems: [
      ...
      { id: "systems", title: "أنظمتنا", desc: "82 نظام ذكاء اصطناعي متكامل" },
  ...
  th: {
    ...
    navItems: [
      ...
      { id: "systems", title: "ระบบของเรา", desc: "82 ระบบ AI ที่เชื่อมต่อกัน" },
