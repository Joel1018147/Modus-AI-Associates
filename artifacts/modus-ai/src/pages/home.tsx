...
const content = {
  en: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Our Systems", desc: "85 integrated AI systems" },
  ...
  bm: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "85 sistem AI bersepadu" },
  ...
  cn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "我们的系统", desc: "85个集成 AI 系统" },
  ...
  id: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Sistem Kami", desc: "85 sistem AI terintegrasi" },
  ...
  vn: {
    ...
    navItems: [
      ...
      { id: "systems", title: "Hệ Thống Của Chúng Tôi", desc: "85 hệ thống AI tích hợp" },
  ...
  ar: {
    ...
    navItems: [
      ...
      { id: "systems", title: "أنظمتنا", desc: "85 نظام ذكاء اصطناعي متكامل" },
  ...
  th: {
    ...
    navItems: [
      ...
      { id: "systems", title: "ระบบของเรา", desc: "85 ระบบ AI ที่เชื่อมต่อกัน" },
